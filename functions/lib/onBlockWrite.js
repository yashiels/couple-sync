...
async function handleBlockWrite(coupleId, deps) {
    ...
    const windows = (0, overlap_1.computeOverlap)(blocksA, blocksB, timezoneA, timezoneB);
...
exports.onBlockWrite = (0, firestore_1.onDocumentWritten)('timeblocks/{coupleId}/blocks/{blockId}', async (event) => {
